          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center text-center space-y-6 max-w-4xl mx-auto">
              <div className="space-y-6">
                ...
                <h1 className="text-4xl font-extrabold lg:text-5xl xl:text-6xl leading-[1.4] text-center">
                  {/* 첫 번째 줄 */}
                ...
                <p className="max-w-[650px] text-slate-500 md:text-lg mx-auto">
                  컴패스는 단순한 취업 지원을 넘어, 당신의 커리어 여정을
                  함께하는 동반자입니다.
                  <br />
          ...
          <div className="container px-4 md:px-6">
            <div className="max-w-4xl mx-auto flex flex-col items-center text-center space-y-12">
              ...
              <div className="grid md:grid-cols-2 gap-8 text-left">
                <div className="flex gap-4 p-6 rounded-2xl bg-slate-50">
